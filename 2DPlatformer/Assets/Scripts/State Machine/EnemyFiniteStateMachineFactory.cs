public class EnemyFiniteStateMachineFactory
{
    ...
    public FiniteStateMachine Create()
    {
        ...
        finiteStateMachine
            ...
            .AddTransition<EnemyFollowState, EnemyAttackState>(() => _context.AttackTrigger.CanAttack)
            .AddTransition<EnemyAttackState, EnemyFollowState>(() => _context.AttackTrigger.CanAttack == false)
